...
'
Namespace Seguridad.DatSeguridad.Dat_Usuarios
    ...
    Partial Public Class Dat_Usuarios
        ...
        Public Sub New()
            MyBase.New()
            Me.Url = ConfigurationManager.AppSettings(Constantes.ServidorDatos) + "DatSeguridad/Dat_Usuarios.asmx"
        End Sub
        ...
        Public Sub TraerRegistroBD( _
                    ...
                    ByVal usuario As String, _
                    ByVal IP As String)
            Dim results() As Object = Me.Invoke("TraerRegistroBD", New Object() {varCodigoUsuario, varNombre1, varNombre2, varApellido1, varApellido2, varLogin, varEstado, varCedula, varIdentificador1, varIdentificador2, varTipoAccesoEstaciones, varCuentaBloqueada, varCambiarClave, varCodigoHorario, usuario, IP})
        ...
        Public Function BeginTraerRegistroBD( _
                    ...
                    ByVal callback As System.AsyncCallback, _
                    ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("TraerRegistroBD", New Object() {varCodigoUsuario, varNombre1, varNombre2, varApellido1, varApellido2, varLogin, varEstado, varCedula, varIdentificador1, varIdentificador2, varTipoAccesoEstaciones, varCuentaBloqueada, varCambiarClave, varCodigoHorario, usuario, IP}, callback, asyncState)
        End Function

        '''<remarks/>
        Public Sub EndTraerRegistroBD(ByVal asyncResult As System.IAsyncResult, ByRef varNombre1 As String, ByRef varNombre2 As String, ByRef varApellido1 As String, ByRef varApellido2 As String, ByRef varLogin As String, ByRef varEstado As Char, ByRef varCedula As String, ByRef varIdentificador1 As String, ByRef varIdentificador2 As String, ByRef varTipoAccesoEstaciones As Boolean, ByRef varCuentaBloqueada As Boolean, ByRef varCambiarClave As Boolean, ByRef varCodigoHorario As Double)
            Dim results() As Object = Me.EndInvoke(asyncResult)
            varNombre1 = CType(results(0), String)
            varNombre2 = CType(results(1), String)
            varApellido1 = CType(results(2), String)
        ...
        Public Overloads Sub TraerRegistroBDAsync( _
                    ...
                    ByVal usuario As String, _
                    ByVal IP As String)
            Me.TraerRegistroBDAsync(varCodigoUsuario, varNombre1, varNombre2, varApellido1, varApellido2, varLogin, varEstado, varCedula, varIdentificador1, varIdentificador2, varTipoAccesoEstaciones, varCuentaBloqueada, varCambiarClave, varCodigoHorario, usuario, IP, Nothing)
        End Sub
        ...
        Public Overloads Sub TraerRegistroBDAsync( _
            ...
            End If
            Me.InvokeAsync("TraerRegistroBD", New Object() {varCodigoUsuario, varNombre1, varNombre2, varApellido1, varApellido2, varLogin, varEstado, varCedula, varIdentificador1, varIdentificador2, varTipoAccesoEstaciones, varCuentaBloqueada, varCambiarClave, varCodigoHorario, usuario, IP}, Me.TraerRegistroBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub AgregarBD_Login(ByVal varLogin As String, ByVal varPalabraClave As String, ByVal varNombre As String, ByVal usuario As String, ByVal IP As String)
            Me.Invoke("AgregarBD_Login", New Object() {varLogin, varPalabraClave, varNombre, usuario, IP})
        End Sub
        ...
        '''<remarks/>
        Public Sub EndAgregarBD_Login(ByVal asyncResult As System.IAsyncResult)
            Me.EndInvoke(asyncResult)
        End Sub
        ...
        Private Sub OnAgregarBD_LoginOperationCompleted(ByVal arg As Object)
            If (Not (Me.AgregarBD_LoginCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg, System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent AgregarBD_LoginCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        ...
        Public Sub BorrarBD_Login(ByVal varLogin As String)
            Me.Invoke("BorrarBD_Login", New Object() {varLogin})
        End Sub
        ...
        '''<remarks/>
        Public Sub EndBorrarBD_Login(ByVal asyncResult As System.IAsyncResult)
            Me.EndInvoke(asyncResult)
        End Sub
        ...
        Private Sub OnBorrarBD_LoginOperationCompleted(ByVal arg As Object)
            If (Not (Me.BorrarBD_LoginCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg, System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent BorrarBD_LoginCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub

        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.prosoft.cr/CambiarBD_Login", RequestNamespace:="http://www.prosoft.cr/", ResponseNamespace:="http://www.prosoft.cr/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)> _
        Public Sub CambiarBD_Login(ByVal varLogin As String, ByVal varPalabraClave As String, ByVal varNombre As String)
            Me.Invoke("CambiarBD_Login", New Object() {varLogin, varPalabraClave, varNombre})
        End Sub
        ...
        '''<remarks/>
        Public Sub EndCambiarBD_Login(ByVal asyncResult As System.IAsyncResult)
            Me.EndInvoke(asyncResult)
        End Sub
        ...
        Private Sub OnCambiarBD_LoginOperationCompleted(ByVal arg As Object)
            If (Not (Me.CambiarBD_LoginCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg, System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent CambiarBD_LoginCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        ...
        Public Sub CambiarClaveBD(ByVal varLogin As String, ByVal varPalabraClaveActual As String, ByVal varClaveNueva As String)
            Me.Invoke("CambiarClaveBD", New Object() {varLogin, varPalabraClaveActual, varClaveNueva})
        End Sub
        ...
        '''<remarks/>
        Public Sub EndCambiarClaveBD(ByVal asyncResult As System.IAsyncResult)
            Me.EndInvoke(asyncResult)
        End Sub
        ...
        Private Sub OnCambiarClaveBDOperationCompleted(ByVal arg As Object)
            If (Not (Me.CambiarClaveBDCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg, System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent CambiarClaveBDCompleted(Me, New System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")> _
    Public Delegate Sub AgregarBD_LoginCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)

    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")> _
    Public Delegate Sub BorrarBD_LoginCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)

    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")> _
    Public Delegate Sub CambiarBD_LoginCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)

    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")> _
    Public Delegate Sub CambiarClaveBDCompletedEventHandler(ByVal sender As Object, ByVal e As System.ComponentModel.AsyncCompletedEventArgs)
End Namespace