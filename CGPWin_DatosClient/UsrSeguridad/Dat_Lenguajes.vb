...
'
Namespace Seguridad.UsrSeguridad.Dat_Lenguajes
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.1432"), _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="Dat_LenguajesSoap", [Namespace]:="http://www.prosoft.cr/")> _
    Partial Public Class Dat_Lenguajes
        ...
        Public Sub New()
            MyBase.New()
            Me.Url = ConfigurationManager.AppSettings(Constantes.ServidorDatos) + "UsrSeguridad/Dat_Lenguajes.asmx"
        ...
        Public Sub AgregarBD(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.Invoke("AgregarBD", New Object() {varCodigoLenguaje, varNombre, varEstado})
        End Sub

        '''<remarks/>
        Public Function BeginAgregarBD(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("AgregarBD", New Object() {varCodigoLenguaje, varNombre, varEstado}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.AgregarBDAsync(varCodigoLenguaje, varNombre, varEstado, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("AgregarBD", New Object() {varCodigoLenguaje, varNombre, varEstado}, Me.AgregarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub BorrarBD(ByVal varCodigoLenguaje As Double)
            Me.Invoke("BorrarBD", New Object() {varCodigoLenguaje})
        End Sub

        '''<remarks/>
        Public Function BeginBorrarBD(ByVal varCodigoLenguaje As Double, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("BorrarBD", New Object() {varCodigoLenguaje}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal varCodigoLenguaje As Double)
            Me.BorrarBDAsync(varCodigoLenguaje, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal varCodigoLenguaje As Double, ByVal userState As Object)
            If (Me.BorrarBDOperationCompleted Is Nothing) Then
                Me.BorrarBDOperationCompleted = AddressOf Me.OnBorrarBDOperationCompleted
            End If
            Me.InvokeAsync("BorrarBD", New Object() {varCodigoLenguaje}, Me.BorrarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub ModificarBD(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.Invoke("ModificarBD", New Object() {varCodigoLenguaje, varNombre, varEstado})
        End Sub

        '''<remarks/>
        Public Function BeginModificarBD(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ModificarBD", New Object() {varCodigoLenguaje, varNombre, varEstado}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub ModificarBDAsync(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.ModificarBDAsync(varCodigoLenguaje, varNombre, varEstado, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub ModificarBDAsync(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ModificarBD", New Object() {varCodigoLenguaje, varNombre, varEstado}, Me.ModificarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub TraerRegistroBD(ByVal varCodigoLenguaje As Double, ByRef varNombre As String, ByRef varEstado As Char)
            Dim results() As Object = Me.Invoke("TraerRegistroBD", New Object() {varCodigoLenguaje, varNombre, varEstado})
            varNombre = CType(results(0), String)
            varEstado = CType(results(1), Char)
        End Sub

        '''<remarks/>
        Public Function BeginTraerRegistroBD(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("TraerRegistroBD", New Object() {varCodigoLenguaje, varNombre, varEstado}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub TraerRegistroBDAsync(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.TraerRegistroBDAsync(varCodigoLenguaje, varNombre, varEstado, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub TraerRegistroBDAsync(ByVal varCodigoLenguaje As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("TraerRegistroBD", New Object() {varCodigoLenguaje, varNombre, varEstado}, Me.TraerRegistroBDOperationCompleted, userState)
        End Sub
