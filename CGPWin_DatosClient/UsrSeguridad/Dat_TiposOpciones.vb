...
'
Namespace Seguridad.UsrSeguridad.Dat_TiposOpciones
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.1432"), _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="Dat_TiposOpcionesSoap", [Namespace]:="http://www.prosoft.cr/")> _
    Partial Public Class Dat_TiposOpciones
        ...
        Public Sub New()
            MyBase.New()
            Me.Url = ConfigurationManager.AppSettings(Constantes.ServidorDatos) + "UsrSeguridad/Dat_TiposOpciones.asmx"
        End Sub
        ...
        Public Sub AgregarBD(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.Invoke("AgregarBD", New Object() {varCodigoTipoOpcion, varNombre, varEstado})
        End Sub

        '''<remarks/>
        Public Function BeginAgregarBD(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("AgregarBD", New Object() {varCodigoTipoOpcion, varNombre, varEstado}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.AgregarBDAsync(varCodigoTipoOpcion, varNombre, varEstado, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("AgregarBD", New Object() {varCodigoTipoOpcion, varNombre, varEstado}, Me.AgregarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub BorrarBD(ByVal varCodigoTipoOpcion As Double)
            Me.Invoke("BorrarBD", New Object() {varCodigoTipoOpcion})
        End Sub

        '''<remarks/>
        Public Function BeginBorrarBD(ByVal varCodigoTipoOpcion As Double, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("BorrarBD", New Object() {varCodigoTipoOpcion}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal varCodigoTipoOpcion As Double)
            Me.BorrarBDAsync(varCodigoTipoOpcion, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal varCodigoTipoOpcion As Double, ByVal userState As Object)
            If (Me.BorrarBDOperationCompleted Is Nothing) Then
                Me.BorrarBDOperationCompleted = AddressOf Me.OnBorrarBDOperationCompleted
            End If
            Me.InvokeAsync("BorrarBD", New Object() {varCodigoTipoOpcion}, Me.BorrarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub ModificarBD(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.Invoke("ModificarBD", New Object() {varCodigoTipoOpcion, varNombre, varEstado})
        End Sub

        '''<remarks/>
        Public Function BeginModificarBD(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ModificarBD", New Object() {varCodigoTipoOpcion, varNombre, varEstado}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub ModificarBDAsync(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.ModificarBDAsync(varCodigoTipoOpcion, varNombre, varEstado, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub ModificarBDAsync(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ModificarBD", New Object() {varCodigoTipoOpcion, varNombre, varEstado}, Me.ModificarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub TraerRegistroBD(ByVal varCodigoTipoOpcion As Double, ByRef varNombre As String, ByRef varEstado As Char)
            Dim results() As Object = Me.Invoke("TraerRegistroBD", New Object() {varCodigoTipoOpcion, varNombre, varEstado})
            varNombre = CType(results(0), String)
            varEstado = CType(results(1), Char)
        End Sub

        '''<remarks/>
        Public Function BeginTraerRegistroBD(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("TraerRegistroBD", New Object() {varCodigoTipoOpcion, varNombre, varEstado}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub TraerRegistroBDAsync(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char)
            Me.TraerRegistroBDAsync(varCodigoTipoOpcion, varNombre, varEstado, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub TraerRegistroBDAsync(ByVal varCodigoTipoOpcion As Double, ByVal varNombre As String, ByVal varEstado As Char, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("TraerRegistroBD", New Object() {varCodigoTipoOpcion, varNombre, varEstado}, Me.TraerRegistroBDOperationCompleted, userState)
        End Sub
