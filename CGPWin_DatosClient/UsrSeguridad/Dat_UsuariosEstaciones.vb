...
'
Namespace Seguridad.UsrSeguridad.Dat_UsuariosEstaciones
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.1432"), _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="Dat_UsuariosEstacionesSoap", [Namespace]:="http://www.prosoft.cr/")> _
    Partial Public Class Dat_UsuariosEstaciones
        ...
        Public Sub New()
            MyBase.New()
            Me.Url = ConfigurationManager.AppSettings(Constantes.ServidorDatos) + "UsrSeguridad/Dat_UsuariosEstaciones.asmx"
        End Sub
        ...
        Public Sub AgregarBD(ByVal varCodigoUsuario As Double, ByVal varCodigoEstacion As Double)
            Me.Invoke("AgregarBD", New Object() {varCodigoUsuario, varCodigoEstacion})
        End Sub

        '''<remarks/>
        Public Function BeginAgregarBD(ByVal varCodigoUsuario As Double, ByVal varCodigoEstacion As Double, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("AgregarBD", New Object() {varCodigoUsuario, varCodigoEstacion}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal varCodigoUsuario As Double, ByVal varCodigoEstacion As Double)
            Me.AgregarBDAsync(varCodigoUsuario, varCodigoEstacion, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal varCodigoUsuario As Double, ByVal varCodigoEstacion As Double, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("AgregarBD", New Object() {varCodigoUsuario, varCodigoEstacion}, Me.AgregarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub BorrarBD(ByVal varCodigoUsuario As Double, ByVal varCodigoEstacion As Double)
            Me.Invoke("BorrarBD", New Object() {varCodigoUsuario, varCodigoEstacion})
        End Sub

        '''<remarks/>
        Public Function BeginBorrarBD(ByVal varCodigoUsuario As Double, ByVal varCodigoEstacion As Double, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("BorrarBD", New Object() {varCodigoUsuario, varCodigoEstacion}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal varCodigoUsuario As Double, ByVal varCodigoEstacion As Double)
            Me.BorrarBDAsync(varCodigoUsuario, varCodigoEstacion, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal varCodigoUsuario As Double, ByVal varCodigoEstacion As Double, ByVal userState As Object)
            If (Me.BorrarBDOperationCompleted Is Nothing) Then
                Me.BorrarBDOperationCompleted = AddressOf Me.OnBorrarBDOperationCompleted
            End If
            Me.InvokeAsync("BorrarBD", New Object() {varCodigoUsuario, varCodigoEstacion}, Me.BorrarBDOperationCompleted, userState)
        End Sub
