...
'
Namespace Seguridad.UsrSeguridad.Dat_Sistemas
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.1432"), _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="Dat_SistemasSoap", [Namespace]:="http://www.prosoft.cr/")> _
    Partial Public Class Dat_Sistemas
        ...
        Public Sub New()
            MyBase.New()
            Me.Url = ConfigurationManager.AppSettings(Constantes.ServidorDatos) + "UsrSeguridad/Dat_Sistemas.asmx"
        End Sub
        ...
        Public Sub AgregarBD(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double)
            Me.Invoke("AgregarBD", New Object() {varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje})
        End Sub

        '''<remarks/>
        Public Function BeginAgregarBD(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("AgregarBD", New Object() {varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double)
            Me.AgregarBDAsync(varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("AgregarBD", New Object() {varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje}, Me.AgregarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub BorrarBD(ByVal varCodigoSistema As Double)
            Me.Invoke("BorrarBD", New Object() {varCodigoSistema})
        End Sub

        '''<remarks/>
        Public Function BeginBorrarBD(ByVal varCodigoSistema As Double, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("BorrarBD", New Object() {varCodigoSistema}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal varCodigoSistema As Double)
            Me.BorrarBDAsync(varCodigoSistema, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal varCodigoSistema As Double, ByVal userState As Object)
            If (Me.BorrarBDOperationCompleted Is Nothing) Then
                Me.BorrarBDOperationCompleted = AddressOf Me.OnBorrarBDOperationCompleted
            End If
            Me.InvokeAsync("BorrarBD", New Object() {varCodigoSistema}, Me.BorrarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub ModificarBD(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double)
            Me.Invoke("ModificarBD", New Object() {varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje})
        End Sub

        '''<remarks/>
        Public Function BeginModificarBD(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ModificarBD", New Object() {varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub ModificarBDAsync(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double)
            Me.ModificarBDAsync(varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub ModificarBDAsync(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ModificarBD", New Object() {varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje}, Me.ModificarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub TraerRegistroBD(ByVal varCodigoSistema As Double, ByRef varNombre As String, ByRef varDescripcion As String, ByRef varEstado As Char, ByRef varCodigoLenguaje As Double)
            Dim results() As Object = Me.Invoke("TraerRegistroBD", New Object() {varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje})
        ...
        '''<remarks/>
        Public Function BeginTraerRegistroBD(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("TraerRegistroBD", New Object() {varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje}, callback, asyncState)
        End Function

        '''<remarks/>
        Public Sub EndTraerRegistroBD(ByVal asyncResult As System.IAsyncResult, ByRef varNombre As String, ByRef varDescripcion As String, ByRef varEstado As Char, ByRef varCodigoLenguaje As Double)
        ...
        '''<remarks/>
        Public Overloads Sub TraerRegistroBDAsync(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double)
            Me.TraerRegistroBDAsync(varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub TraerRegistroBDAsync(ByVal varCodigoSistema As Double, ByVal varNombre As String, ByVal varDescripcion As String, ByVal varEstado As Char, ByVal varCodigoLenguaje As Double, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("TraerRegistroBD", New Object() {varCodigoSistema, varNombre, varDescripcion, varEstado, varCodigoLenguaje}, Me.TraerRegistroBDOperationCompleted, userState)
        End Sub
