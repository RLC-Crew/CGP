...
'
Namespace Seguridad.UsrSeguridad.Dat_SG_UsuariosInfoExtra
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.1432"), _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="Dat_SG_UsuariosInfoExtraSoap", [Namespace]:="http://www.prosoft.cr/")> _
    Partial Public Class Dat_SG_UsuariosInfoExtra
        ...
        Public Sub New()
            MyBase.New()
            Me.Url = ConfigurationManager.AppSettings(Constantes.ServidorDatos) + "UsrSeguridad/Dat_SG_UsuariosInfoExtra.asmx"
        End Sub
        ...
        Public Sub AgregarBD(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String)
            Me.Invoke("AgregarBD", New Object() {v_CodigoUsuario, v_CodigoValor, v_Valor})
        End Sub

        '''<remarks/>
        Public Function BeginAgregarBD(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("AgregarBD", New Object() {v_CodigoUsuario, v_CodigoValor, v_Valor}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String)
            Me.AgregarBDAsync(v_CodigoUsuario, v_CodigoValor, v_Valor, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub AgregarBDAsync(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("AgregarBD", New Object() {v_CodigoUsuario, v_CodigoValor, v_Valor}, Me.AgregarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub BorrarBD(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String)
            Me.Invoke("BorrarBD", New Object() {v_CodigoUsuario, v_CodigoValor})
        End Sub

        '''<remarks/>
        Public Function BeginBorrarBD(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("BorrarBD", New Object() {v_CodigoUsuario, v_CodigoValor}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String)
            Me.BorrarBDAsync(v_CodigoUsuario, v_CodigoValor, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub BorrarBDAsync(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal userState As Object)
            If (Me.BorrarBDOperationCompleted Is Nothing) Then
                Me.BorrarBDOperationCompleted = AddressOf Me.OnBorrarBDOperationCompleted
            End If
            Me.InvokeAsync("BorrarBD", New Object() {v_CodigoUsuario, v_CodigoValor}, Me.BorrarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub ModificarBD(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String)
            Me.Invoke("ModificarBD", New Object() {v_CodigoUsuario, v_CodigoValor, v_Valor})
        End Sub

        '''<remarks/>
        Public Function BeginModificarBD(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("ModificarBD", New Object() {v_CodigoUsuario, v_CodigoValor, v_Valor}, callback, asyncState)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub ModificarBDAsync(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String)
            Me.ModificarBDAsync(v_CodigoUsuario, v_CodigoValor, v_Valor, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub ModificarBDAsync(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("ModificarBD", New Object() {v_CodigoUsuario, v_CodigoValor, v_Valor}, Me.ModificarBDOperationCompleted, userState)
        End Sub
        ...
        Public Sub TraerRegistroBD(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByRef v_Valor As String)
            Dim results() As Object = Me.Invoke("TraerRegistroBD", New Object() {v_CodigoUsuario, v_CodigoValor, v_Valor})
            v_Valor = CType(results(0), String)
        End Sub

        '''<remarks/>
        Public Function BeginTraerRegistroBD(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("TraerRegistroBD", New Object() {v_CodigoUsuario, v_CodigoValor, v_Valor}, callback, asyncState)
        End Function

        '''<remarks/>
        Public Sub EndTraerRegistroBD(ByVal asyncResult As System.IAsyncResult, ByRef v_Valor As String)
            Dim results() As Object = Me.EndInvoke(asyncResult)
            v_Valor = CType(results(0), String)
        End Sub

        '''<remarks/>
        Public Overloads Sub TraerRegistroBDAsync(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String)
            Me.TraerRegistroBDAsync(v_CodigoUsuario, v_CodigoValor, v_Valor, Nothing)
        End Sub

        '''<remarks/>
        Public Overloads Sub TraerRegistroBDAsync(ByVal v_CodigoUsuario As Decimal, ByVal v_CodigoValor As String, ByVal v_Valor As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("TraerRegistroBD", New Object() {v_CodigoUsuario, v_CodigoValor, v_Valor}, Me.TraerRegistroBDOperationCompleted, userState)
        End Sub
    ...
    Partial Public Class TraerRegistroBDCompletedEventArgs
        ...
        '''<remarks/>
        Public ReadOnly Property v_Valor() As String
            Get
